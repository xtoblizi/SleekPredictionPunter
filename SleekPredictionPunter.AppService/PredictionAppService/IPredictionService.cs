...
namespace SleekPredictionPunter.AppService.PredictionAppService
{
    public interface IPredictionService
    {
        ...
        Task<IEnumerable<IGrouping<long, Prediction>>> ReturnRelationalData(Func<Prediction, bool> predicate, bool groupByPredicateCategory = false, bool groupByMatchCategory = false, bool groupByCustomCategory = false, bool groupByBetCategory = false, int count = int.MaxValue);
