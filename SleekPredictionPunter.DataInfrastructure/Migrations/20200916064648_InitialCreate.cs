        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCommission = table.Column<decimal>(type: "decimal(18, 2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "WinningPlanPreviewSummary",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    DateUpdated = table.Column<DateTime>(nullable: true),
                    PlanName = table.Column<string>(nullable: true),
                    Paragraph1Description = table.Column<string>(nullable: true),
                    Paragraph2Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WinningPlanPreviewSummary", x => x.Id);
                });
